...
function preload() {
houseTest = loadJSON('../user_input_default.json');
}
...
function draw() {
    ...
    function startGame() {
        ...
        j=j+1
         ...
         function editJSON() {
if (houseTest.house01.start == false) {
    houseTest.house01.start = true
} else if (houseTest.house01.start == true) {
    houseTest.house01.start = false
}
console.log(houseTest.house01.start)
         }